...
public:
	...
	void SaveReservationToFile(const wxString& name, const wxString& phone, const wxDateTime& date, int mountain, int touring, int gravel, int enduro);
	void DelRes(const wxString& res);
};